...
autocmd FileType perl,sh,markdown,python,mediawiki,javascript,groovy,html setlocal foldmethod=indent ts=4 sw=4 st=4 expandtab tw=0
autocmd FileType css setlocal foldmethod=indent expandtab ts=2 sw=2 st=2
autocmd FileType java,htmldjango,javascript setlocal foldmethod=indent noexpandtab ts=4 sw=4 st=4
